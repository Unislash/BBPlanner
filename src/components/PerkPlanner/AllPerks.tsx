...
const tooltips = {
    ...
    nineLives: <><PerkTooltipHeader title="Nine Lives" />Once per battle, upon receiving a killing blow, survive instead with a few hitpoints left. The next hit is likely to kill you for good, of course.</>,
    ...
    adrenaline: <><PerkTooltipHeader title="Adrenaline" />Unlocks the 'Adrenaline' skill which costs 0 AP and 25 Fatigue to be used and puts you first in the turn order for the next round, to have another turn before your enemies do. Feel the adrenaline rushing through your veins!</>,
    ...
    resilient: <><PerkTooltipHeader title="Resilient" />Keep it together! Any negative status effect with a finite duration (e.g. Bleeding, Charmed) has its duration reduced by -1 turn, to a minimum of 1 turn.</>,
    ...
    quickHands: <><PerkTooltipHeader title="Quick Hands" />Looking for this? Swapping items in battle becomes a free action with no Action Point cost once every turn.</>,
    ...
    anticipation: <><PerkTooltipHeader title="Anticipation" />When being attacked with ranged weapons, gain 1 + 10% of your base Ranged Defense as additional Ranged Defense per tile that the attacker is away.</>,
    ...
    brawny: <><PerkTooltipHeader title="Brawny" />The fatigue penalty from wearing armor and helmet is reduced by 25%</>,
    relentless: <><PerkTooltipHeader title="Relentless" />Don't slow down! At all times your Initiative is reduced only by 50% of your accumulated Fatigue, instead of all of it. You also don't lose Initiative when you wait instead of ending your turn anymore.</>,
    ...
    rally: <><PerkTooltipHeader title="Rally the Troops" />Unlocks the 'Rally the Troops' skill. Rally costs 6 AP, 25 Fatigue and triggers a morale check to raise morale of any ally at Wavering or worse morale within 4 tiles; with a bonus of 40% of the skill user's Resolve, and a penalty of -10 per tile of distance, to the roll. It can also rally fleeing and panicked allies.</>,
    taunt: <><PerkTooltipHeader title="Taunt" />Unlocks the 'Taunt' skill which costs 4 AP and 15 Fatigue to be used and makes opponents take offensive actions instead of defensive ones, and attack the taunting character over another potentially more vulnerable one.</>,
    maceMastery: <><PerkTooltipHeader title="Mace Mastery" />Master maces to beat your opponents into submission, armored or not. Skills build up 25% less Fatigue. Knock Out and Strike Down have a 100% chance to stun the target if not immune.</>,
    flailMastery: <><PerkTooltipHeader title="Flail Mastery" />Master flails and circumvent your opponent's shield. Skills build up 25% less Fatigue. Lash ignores the defense bonus of shield. Thresh gains +5% chance to hit.</>,
    ...
    cleaverMastery: <><PerkTooltipHeader title="Cleaver Mastery" />Master cleavers to inflict gruesome wounds. Skills build up 25% less Fatigue. Bleeding damage inflicted by cleavers is doubled to 10 per turn.</>,
    swordMastery: <><PerkTooltipHeader title="Sword Mastery" />Master the art of swordfighting and using your opponent's mistakes to your advantage. Skills build up 25% less Fatigue. Riposte no longer has a penalty to hitchance. Split and Swing gain a + 5% chance to hit.</>,
    daggerMastery: <><PerkTooltipHeader title="Dagger Mastery" />Master swift and deadly daggers. Skills build up 25% less Fatigue. Stab and Puncture now costs 3 AP to use (instead of 4) which allows for an additional attack each turn.</>,
    ...
    spearMastery: <><PerkTooltipHeader title="Spear Mastery" />Master fighting with spears and keeping the enemy at bay. Skills build up 25% less Fatigue. Spearwall is no longer disabled once an opponent manages to overcome it. Instead, Spearwall continues to give free attacks on any further opponent attempting to enter the Zone of Control. The Spetum no longer has a penalty for attacking targets directly adjacent.</>,
    crossbowMastery: <><PerkTooltipHeader title="Crossbow Mastery" />Master crossbows and learn where to aim best. Skills build up 25% less Fatigue. An additional 20% of damage inflicted with crossbows ignores armor.</>,
    ...
    throwingMastery: <><PerkTooltipHeader title="Throwing Mastery" />Master throwing weapons to wound or kill the enemy before they even get close. Skills build up 25% less Fatigue. Damage is increased by 40% when attacking at 2 tiles of distance. Damage is increased by 20% when attacking at 3 tiles of distance.</>,
    ...
    footwork: <><PerkTooltipHeader title="Footwork" />Unlocks the 'Footwork' skill which costs 3 AP and 25 Fatigue to be used and allows you to leave a zone of control without triggering free attacks by using skillful footwork.</>,
    ...
    headhunter: <><PerkTooltipHeader title="Head Hunter" />Go for the head! Gain +15% chance to hit the head for critical damage each time you hit the body. Bonus is reset upon hitting the head.</>,
    ...
    fearsome: <><PerkTooltipHeader title="Fearsome" />Make them scatter and flee! Any attack that inflicts at least 1 point of damage to hitpoints triggers a morale check for the opponent, as opposed to only if at or above 15 points of damage.</>,
    duelist: <><PerkTooltipHeader title="Duelist" />Become one with your weapon and go for the weak spots! With the offhand free, an additional + 25% of any damage ignores armor. Does not work with two-handed weapons.</>,
    ...
    indomitable: <><PerkTooltipHeader title="Indomitable" />Unlocks the 'Indomitable' skill which costs 3 AP and 20 Fatigue to be used and grants a 50% damage reduction and immunity to being stunned, knocked back or grabbed for one turn.</>,
};
