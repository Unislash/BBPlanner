...
const tooltips = {
    ...
    nineLives: <><PerkTooltipHeader title="Nine Lives" />Once per battle, upon receiving a killing blow, survive instead with a few hitpoints left and have all damage over time effects (e.g. bleeding, poisoned) cured. The next hit is likely to kill you for good, of course, but improved defensive stats until your next turn help you to survive until then (+15 Melee Defense, Ranged Defense, Resolve, and Initiative).</>,
    ...
    headhunter: <><PerkTooltipHeader title="Head Hunter" />Go for the head! Hitting the head of a target will give you a guaranteed hit to the head also with your next attack. Connecting with your hit, or missing with your attack, will reset the effect.</>,
