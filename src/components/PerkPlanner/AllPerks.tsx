...
const tooltips = {
    ...
    resilient: <><PerkTooltipHeader title="Resilient" />Keep it together! Any status effect with a finite duration (e.g. Bleeding, Charmed) has its duration reduced to 1 turn.</>,
    ...
    relentless: <><PerkTooltipHeader title="Relentless" />Don't slow down! At all times your Initiative is reduced only by 50% of your accumulated Fatigue, instead of all of it.</>,
    ...
    flailMastery: <><PerkTooltipHeader title="Flail Mastery" />Master flails and circumvent your opponent's shield. Skills build up 25% less Fatigue. Lash and Hail ignore the defense bonus of shield. Thresh gains +5% chance to hit.</>,
