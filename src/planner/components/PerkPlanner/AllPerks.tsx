...
const tooltips = {
    ...
    colossus: <><PerkTooltipHeader title="Colossus" />Bring it on! Hitpoints are increased by 25%, which also reduces the chance to sustain debilitating injuries when being hit.<br /><br />Affected stats indicated with ✤</>,
    ...
    fortifiedMind: <><PerkTooltipHeader title="Fortified Mind" />An iron will is not swayed from the true path easily. Resolve is increased by 25%.<br /><br />Affected stats indicated with †</>,
    ...
    gifted: <><PerkTooltipHeader title="Gifted" />Mercenary life comes easy when you're naturally gifted. Instantly gain a levelup to increase this character's attributes with maximum rolls but without talents.<br /><br />Affected stats indicated with *</>,
    ...
    fearsome: <><PerkTooltipHeader title="Fearsome" />Make them scatter and flee! Any attack that inflicts at least 1 point of damage to hitpoints triggers a morale check for the opponent with a penalty equal to 15% of your Resolve - 10, as opposed to no penalty and only if at or above 15 points of damage.</>,
