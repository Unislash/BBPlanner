    ...
    return (
        <div className="otherResources">
            ...
            <div className="otherResourcesCopy">
                ...
                <p>
                    <a href="http://tumult.cc/bb-calc.html">
                        Tumult BB Calc
                        <HyperlinkIcon />
                    </a>
                </p>
                <p>
                    <a href="https://battlebrothers.fandom.com/wiki/Battle_Brothers_Wiki">
                ...
                <p>
                    <a href="https://www.nexusmods.com/battlebrothers/mods">
                        Mods on Nexus
                        <HyperlinkIcon />
                    </a>
                </p>
                <p>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">
                        Battle Brothers Reddit
                        <HyperlinkIcon />
                    </a>
                </p>
                <p>
                    <a href="http://battlebrothersgame.com">
                        Battle Brothers Website
                        <HyperlinkIcon />
                    </a>
                </p>
                <p>
                    <a href="mailto:unislash@bbplanner.xyz">Contact Me</a>
                </p>
            </div>
        </div>
    );
