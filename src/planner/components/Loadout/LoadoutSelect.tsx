...
export const LoadoutSelect = (props: LoadoutSelectProps): JSX.Element => {
    const { options, selected, onItemChange, loadoutSlotType } = props;
    ...
    return (
        <LoadoutFlyout
            ...
            target={
                <Tooltip
                    overlay={<LoadoutTooltip loadoutSlotType={loadoutSlotType} item={selected} />}
                    placement="right"
                    mouseEnterDelay={
                        ...
                        selected.name === EMPTY_NAME ? 100 : 0.5
                    }
                >
                    <LoadoutSlotButton
                        loadoutSlotType={loadoutSlotType}
